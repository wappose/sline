...
// by panes that need to do some processing before other panes are
	...
	function prepare_regions($region_pane_list, $settings) {
		...
		$default = array ('style' => panels_get_style ( ! empty ( $settings ['style'] ) ? $settings ['style'] : 'default' ), 'style settings' => isset ( $settings ['style_settings'] ['default'] ) ? $settings ['style_settings'] ['default'] : array () );
